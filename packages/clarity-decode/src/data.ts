    ...
    switch (event) {
        ...
        case Data.Event.Baseline:
            ...
            let baselineData: Data.BaselineData = {
                ...
                docW: tokens[3] as number,
                docH: tokens[4] as number,
                scrW: tokens[5] as number,
                scrH: tokens[6] as number,
                srlX: tokens[7] as number,
                srlY: tokens[8] as number,
                ptrX: tokens[9] as number,
                ptrY: tokens[10] as number,
                tActivity: tokens[11] as number,
                tSrl: tokenLength > 12 ? tokens[12] as number: null,
                tPtr: tokenLength > 13 ? tokens[13] as number: null,
                moveX: tokenLength > 14 ? tokens[14] as number: null,
                moveY: tokenLength > 15 ? tokens[15] as number: null,
                tMove: tokenLength > 16 ? tokens[16] as number: null,
                downX: tokenLength > 17 ? tokens[17] as number: null, 
                downY: tokenLength > 18 ? tokens[18] as number: null,
                tDown: tokenLength > 19 ? tokens[19] as number: null,
                upX: tokenLength > 20 ? tokens[20] as number: null,
                upY: tokenLength > 21 ? tokens[21] as number: null,
                tUp: tokenLength > 22 ? tokens[22] as number: null,
                ptrPrevX: tokenLength > 23 ? tokens[23] as number: null,
                ptrPrevY: tokenLength > 24 ? tokens[24] as number: null,
                tPtrPrev: tokenLength > 25 ? tokens[25] as number: null,
            }
