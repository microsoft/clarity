...
export function decode(tokens: Data.Token[]): InteractionEvent {
    ...
    switch (event) {
        ...
        case Data.Event.TouchMove:
            let pointerData: Interaction.PointerData = { target: tokens[2] as number, x: tokens[3] as number, y: tokens[4] as number };
        ...
        case Data.Event.Scroll:
            let scrollData: Interaction.ScrollData = { target: tokens[2] as number, x: tokens[3] as number, y: tokens[4] as number };
