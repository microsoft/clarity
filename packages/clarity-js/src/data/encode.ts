    ...
    switch (event) {
        case Event.Baseline: {
            ...
            if (b && b.data) {
                ...
                tokens.push(b.data.docW);
                tokens.push(b.data.docH);
                tokens.push(b.data.scrW);
                tokens.push(b.data.scrH);
                tokens.push(b.data.srlX);
                tokens.push(b.data.srlY);
                tokens.push(b.data.ptrX);
                tokens.push(b.data.ptrY);
                tokens.push(b.data.tActivity);
                tokens.push(b.data.tSrl);
                tokens.push(b.data.tPtr);
                tokens.push(b.data.moveX);
                tokens.push(b.data.moveY);
                tokens.push(b.data.tMove);
                tokens.push(b.data.downX);
                tokens.push(b.data.downY);
                tokens.push(b.data.tDown);
                tokens.push(b.data.upX);
                tokens.push(b.data.upY);
                tokens.push(b.data.tUp);
                tokens.push(b.data.ptrPrevX);
                tokens.push(b.data.ptrPrevY);
                tokens.push(b.data.tPtrPrev);
                queue(tokens, false);
            }
            baseline.reset();
            break;
